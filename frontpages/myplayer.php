...
$tabArray = array(
	...
	//'#settings' => PLAYER_CHANGE_SETTINGS
);
...
if ( MEMMOD != 1 )
{
	...
	$opsTheme->addVariable('player_settings_label',         PLAYER_CHANGE_SETTINGS);
	...
	$opsTheme->addVariable('player_submit_button_label',    BUTTON_SAVE_SETTINGS);
}
...
$opsTheme->addVariable('panel_settings', $opsTheme->viewPart('myplayer-panel-settings'));*/
...
$panels .= $opsTheme->viewPart('myplayer-panel-settings');
...
$opsTheme->addVariable('profile', array(
	'image' => array(
		'more' => $addons->get_hooks(array(),
			array(
				'page'     => 'myplayer.php',
				'location' => 'profile_image_more'
			)
		)
	)
));
