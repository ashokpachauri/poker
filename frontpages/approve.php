...
// Connection database
$pdo = new PDO("mysql:host=$host;charset=$charset", $ln, $pw) or die('Unable to connect to database  - <a href="http://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'] . 'install/">' . __( 'Click here to install OPS V2', 'core' ) . '</a>');
$pdo->query("USE $db") or die(__( 'Unable to select database', 'core' ));
