...
if (isset($updateJson->description) && !empty($updateJson->description))
{
	$description  = str_replace("\r\n", '<br>', $updateJson->description);
	$description .= '<hr>';
	$opsTheme->addVariable('description', $description);
}
...
if (isset($updateJson->changelog) && is_array($updateJson->changelog))
{
	...
	{
		$opsTheme->addVariable('log', $changelog_file);
		$logs .= $opsTheme->viewPart('admin-update-changelog-each');
	}

	$opsTheme->addVariable('logs',      $logs);
	$opsTheme->addVariable('changelog', $opsTheme->viewPart('admin-update-changelog'));
}
