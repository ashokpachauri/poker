	...
	array(
		'content' => array(
			array(
                'value'    => 'c',
                'label'    => CASHGAMES,
                'selected' => $tabler['tabletype'] == 'c' ? true : false
            ),
			array(
                'value'    => 's',
                'label'    => SITNGO,
                'selected' => $tabler['tabletype'] == 's' ? true : false
            ),
			array(
                'value'    => 't',
                'label'    => TOURNAMENT,
                'selected' => $tabler['tabletype'] == 't' ? true : false
                )
		)
	),
	array(
...
$tableAnims = $addons->get_hooks(
    ...
    array(
        'page'     => 'admin/edit-table.php',
        'location'  => 'table_animations'
    )
);
$opsTheme->addVariable('table_anims', $tableAnims);


$tableStraddles = $addons->get_hooks(
    array(
        'content' => array(
            array('value' => 0,   'label' => __( 'No', 'core' )),
            array('value' => 1,   'label' => __( 'Yes', 'core' )),
    ...
    array(
        'page'     => 'admin/edit-table.php',
        'location'  => 'table_straddles'
    )
);
$opsTheme->addVariable('table_straddles', $tableStraddles);
