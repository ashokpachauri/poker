...
class MysqlBackup
{
	...
	/**
	 * Constructor of MysqlBackup. Note that in the case of an SQLite database
	...
	public function __construct(
		...
		$dumpSettingsDefault = array(
			...
			'databases' => false,
			'default-character-set' => MysqlBackup::UTF8,
			'disable-keys' => true,
		...
		// If no include-views is passed in, dump the same views as tables, mimic MysqlBackup behaviour.
	...
	/**
	 * Destructor of MysqlBackup. Unsets dbHandlers and database objects.
	 */
